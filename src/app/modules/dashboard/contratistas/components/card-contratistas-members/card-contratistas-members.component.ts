...
import { setDetailsContratista, showCard } from '@app/stores/contratistas/actions';
...
export class CardContratistasMembersComponent implements OnInit {
  ...
  setUserControlContratista(contratista: MemberDetails): void {
    this.show = true;
    this.detailMember = contratista;
  }

  closeModalControl(event: boolean): void {
    this.show = event;
  }
}
